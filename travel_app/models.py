...
class Questionnaire(models.Model):
    ...
    #user = models.ForeignKey(Usersignup, default=None, on_delete=models.CASCADE)
    username = models.CharField(null=True, max_length=20)
    adventure = models.IntegerField(null=True, default=0)
    heritage = models.IntegerField(null=True, default=0)
    wildlife = models.IntegerField(null=True, default=0)
    nature = models.IntegerField(null=True, default=0)
    pilgrimage = models.IntegerField(null=True, default=0)
    couple = models.IntegerField(null=True, default=0)
    friends = models.IntegerField(null=True, default=0)
    family = models.IntegerField(null=True, default=0)
    winter = models.IntegerField(null=True, default=0)
    spring = models.IntegerField(null=True, default=0)
    summer = models.IntegerField(null=True, default=0)
    monsoon = models.IntegerField(null=True, default=0)
    autumn = models.IntegerField(null=True, default=0)
    young = models.IntegerField(null=True, default=0)
    mid_age = models.IntegerField(null=True, default=0)
    old = models.IntegerField(null=True, default=0)
    visited_state = models.CharField(null=True, default='null',max_length=20)
    visited_city = models.CharField(null=True, default='null',max_length=20)
    rate_place = models.IntegerField(null=True, default=0)
